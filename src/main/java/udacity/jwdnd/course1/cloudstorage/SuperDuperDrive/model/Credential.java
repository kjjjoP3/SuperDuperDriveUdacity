...
public class Credential {
    ...
    public String getPasswordUnCredential() {
        return passwordUnCredential;
    }

    public void setPasswordUnCredential(String passwordUnCredential) {
        this.passwordUnCredential = passwordUnCredential;
    }
